...
/* ---- inlined: components/parts-categories/styles.ts ---- */
...
/* ---- inlined: components/parts-categories/types.ts ---- */
type CategoryLayout = 'grid' | 'showcase' | 'projects' | 'slider';
...
/* ---- inlined: components/parts-categories/utils.ts ---- */
const SAMPLE_IMAGES = [
...
function resolveLayout(config: Record<string, unknown>): CategoryLayout {
...
function showLayoutToggle(config: Record<string, unknown>): boolean {
  return isTruthy(config.pca_show_layout_toggle, false);
}

function resolveColumns(config: Record<string, unknown>): number {
...
function splitShowcaseItems(items: CategoryItem[]): {
  mosaic: CategoryItem[];
  rest: CategoryItem[];
} {
 ...
 */
function splitProjectsItems(items: CategoryItem[]): {
  stack: CategoryItem[];
...
/* ---- inlined: components/parts-categories/index.ts ---- */
type CardOpts = {
  tile?: boolean;
  feature?: boolean;
};
