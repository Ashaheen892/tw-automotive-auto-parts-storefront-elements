...
/* ---- inlined: components/part-journey-timeline/styles.ts ---- */
...
/* ---- inlined: components/part-journey-timeline/types.ts ---- */
...
/* ---- inlined: components/part-journey-timeline/utils.ts ---- */
function parseStages(raw: unknown): JourneyStage[] {
...
/* ---- inlined: components/part-journey-timeline/index.ts ---- */
