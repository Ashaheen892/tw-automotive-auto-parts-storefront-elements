...
/* ---- inlined: components/driving-conditions-guide/styles.ts ---- */
...
/* ---- inlined: components/driving-conditions-guide/types.ts ---- */
...
type ConditionsLayout = 'cards' | 'tabs';

/* ---- inlined: components/driving-conditions-guide/utils.ts ---- */
...
function resolveLayout(value: unknown): ConditionsLayout {
  const raw = getRadioValue(value, 'cards').toLowerCase();
  return raw === 'tabs' ? 'tabs' : 'cards';
}

function parseConditions(raw: unknown): DrivingCondition[] {
...
/* ---- inlined: components/driving-conditions-guide/index.ts ---- */
