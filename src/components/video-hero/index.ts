...
/* ---- inlined: components/video-hero/styles.ts ---- */
...
/* ---- inlined: components/video-hero/types.ts ---- */
type VideoHeroAlign = 'start' | 'center' | 'end';

/* ---- inlined: components/video-hero/utils.ts ---- */
const DEFAULT_POSTER =
  'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1800&q=80';

function resolveVideoUrl(config: Record<string, unknown>): string {
  const raw =
...
function resolvePoster(config: Record<string, unknown>): string {
  return (
...
function resolveAlign(config: Record<string, unknown>): VideoHeroAlign {
...
function resolveSecondaryCta(config: Record<string, unknown>): {
  label: string;
  link: string;
} {
  return {
...
function videoPlaybackFlags(config: Record<string, unknown>): {
  autoplay: boolean;
  muted: boolean;
  loop: boolean;
} {
...
/* ---- inlined: components/video-hero/index.ts ---- */
