...
/* ---- inlined: components/tire-battery-selection-guide/styles.ts ---- */
...
/* ---- inlined: components/tire-battery-selection-guide/types.ts ---- */
type GuideMode = 'tires' | 'batteries' | 'both';
...
/* ---- inlined: components/tire-battery-selection-guide/utils.ts ---- */
function resolveMode(value: unknown): GuideMode {
  const raw = getRadioValue(value, 'both').toLowerCase();
  if (raw === 'tires' || raw === 'batteries') return raw;
  return 'both';
}

function parseTireCode(raw: string): ParsedTireCode | null {
...
function parseTireParts(raw: unknown, example: ParsedTireCode | null): TirePart[] {
...
function parseBatterySpecs(raw: unknown): BatterySpec[] {
...
function parseTireNotes(raw: unknown): string {
...
/* ---- inlined: components/tire-battery-selection-guide/index.ts ---- */
