...
/* ---- inlined: components/dashboard-warning-guide/styles.ts ---- */
...
/* ---- inlined: components/dashboard-warning-guide/types.ts ---- */
...
/* ---- inlined: components/dashboard-warning-guide/utils.ts ---- */
...
function parseWarnings(raw: unknown): DashboardWarning[] {
...
function severityValueLabel(severity: WarningSeverity): string {
...
function severityFieldLabel(config: Record<string, unknown>): string {
  return localizedString(config.dwg_severity_label as LocaleValue) || t('الخطورة', 'Severity');
}

function severityClass(severity: WarningSeverity): string {
...
/* ---- inlined: components/dashboard-warning-guide/index.ts ---- */
