...
/* ---- inlined: components/whatsapp-contact-banner/styles.ts ---- */
...
/* ---- inlined: components/whatsapp-contact-banner/utils.ts ---- */
function resolveStorePhone(config: Record<string, unknown>): string {
  return (
...
function resolvePrefillMessage(config: Record<string, unknown>): string {
  return (
...
function resolveWhatsAppHref(config: Record<string, unknown>): string {
  const phone = resolveStorePhone(config);
  if (!phone) return '';
  return buildWhatsAppUrl(phone, resolvePrefillMessage(config));
}

/* ---- inlined: components/whatsapp-contact-banner/index.ts ---- */
