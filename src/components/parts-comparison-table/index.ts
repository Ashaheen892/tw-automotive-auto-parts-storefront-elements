...
/* ---- inlined: components/parts-comparison-table/styles.ts ---- */
...
/* ---- inlined: components/parts-comparison-table/types.ts ---- */
type ComparisonLayout = 'table' | 'cards';
...
/* ---- inlined: components/parts-comparison-table/utils.ts ---- */
...
function resolveLayout(value: unknown): ComparisonLayout {
  const raw = getRadioValue(value, 'table').toLowerCase();
  return raw === 'cards' ? 'cards' : 'table';
}

function parseTypes(raw: unknown): PartType[] {
...
function parseCriteriaRows(raw: unknown): CriteriaRow[] {
...
function getCellValue(type: PartType, key: CriteriaKey): string {
  return type[key] || '—';
}
...
/* ---- inlined: components/parts-comparison-table/index.ts ---- */
