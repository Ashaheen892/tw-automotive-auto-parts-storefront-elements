...
/* ---- inlined: components/part-compatibility-card/styles.ts ---- */
...
/* ---- inlined: components/part-compatibility-card/types.ts ---- */
interface CompatibilityField {
  id: string;
  label: string;
  placeholder: string;
  required: boolean;
 ...
 */
function normalizeWhatsAppPhone(raw: unknown, defaultCountry = '966'): string {
...
/* ---- inlined: components/part-compatibility-card/utils.ts ---- */
function parseCustomFields(raw: unknown): CompatibilityField[] {
...
function resolveCtaUrl(config: Record<string, unknown>): string {
  return extractLink(config.pcc_cta_url);
}

function whatsappPhone(config: Record<string, unknown>): string {
...
function showField(config: Record<string, unknown>, key: string, fallback = true): boolean {
...
/* ---- inlined: components/part-compatibility-card/index.ts ---- */
