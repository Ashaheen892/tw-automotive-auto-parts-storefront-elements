...
/* ---- inlined: components/parts-feature-spotlight/styles.ts ---- */
...
/* ---- inlined: components/parts-feature-spotlight/types.ts ---- */
...
/* ---- inlined: components/parts-feature-spotlight/utils.ts ---- */
const DEFAULT_META = [
  {
    ar: 'أداء عالي',
    en: 'High performance',
...
function splitFeatures(items: FeatureItem[]): {
  start: FeatureItem[];
  end: FeatureItem[];
} {
...
function showConnectors(config: Record<string, unknown>): boolean {
  return isTruthy(config.pfs_show_connectors, true);
}

/* ---- inlined: components/parts-feature-spotlight/index.ts ---- */
