...
/* ---- inlined: components/vehicle-needs-checker/styles.ts ---- */
...
/* ---- inlined: components/vehicle-needs-checker/types.ts ---- */
...
/* ---- inlined: components/vehicle-needs-checker/utils.ts ---- */
...
function parseResults(raw: unknown): QuizResult[] {
  const parsed = normalizeCollection(raw)
    .map((row, i) => {
...
function progressPercent(stepIndex: number, total: number): number {
  if (total <= 0) return 0;
...
/* ---- inlined: components/vehicle-needs-checker/index.ts ---- */
