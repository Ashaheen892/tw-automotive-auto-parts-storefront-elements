...
/* ---- inlined: components/garage-banners/styles.ts ---- */
...
/* ---- inlined: components/garage-banners/types.ts ---- */
...
/* ---- inlined: components/garage-banners/utils.ts ---- */
const B1 =
...
function parseBanners(raw: unknown): BannerItem[] {
...
/* ---- inlined: components/garage-banners/index.ts ---- */
