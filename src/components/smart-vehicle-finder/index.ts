...
/* ---- inlined: components/smart-vehicle-finder/styles.ts ---- */
...
/* ---- inlined: components/smart-vehicle-finder/types.ts ---- */
...
/* ---- inlined: components/smart-vehicle-finder/utils.ts ---- */
/**
 * Parse merchant vehicle table.
 * One row = company (brand) + logo.
 */
function parseVehicleRows(raw: unknown): VehicleRow[] {
...
function resolveVehicleRows(config: Record<string, unknown>): VehicleRow[] {
  return parseVehicleRows(config.svf_vehicles ?? config.svf_custom_vehicles);
}

function brandsFromRows(rows: VehicleRow[]): VehicleBrand[] {
...
/* ---- inlined: components/smart-vehicle-finder/index.ts ---- */
