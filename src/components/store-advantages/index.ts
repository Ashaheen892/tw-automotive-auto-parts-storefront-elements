...
/* ---- inlined: components/store-advantages/styles.ts ---- */
...
/* ---- inlined: components/store-advantages/types.ts ---- */
interface BrandItem {
  id: string;
  name: string;
  image: string;
...
/* ---- inlined: components/store-advantages/utils.ts ---- */
...
function parseBrands(raw: unknown): BrandItem[] {
...
/* ---- inlined: components/store-advantages/index.ts ---- */
