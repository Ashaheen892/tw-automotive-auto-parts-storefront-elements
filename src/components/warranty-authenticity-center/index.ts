...
/* ---- inlined: components/warranty-authenticity-center/styles.ts ---- */
...
/* ---- inlined: components/warranty-authenticity-center/types.ts ---- */
type TrustLayout = 'tabs' | 'accordion' | 'cards';
...
/* ---- inlined: components/warranty-authenticity-center/utils.ts ---- */
function resolveLayout(value: unknown): TrustLayout {
  const raw = getRadioValue(value, 'tabs').toLowerCase();
  if (raw === 'accordion' || raw === 'cards') return raw;
  return 'tabs';
}

function parseItems(raw: unknown): TrustItem[] {
...
/* ---- inlined: components/warranty-authenticity-center/index.ts ---- */
