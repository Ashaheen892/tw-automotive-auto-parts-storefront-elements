...
/* ---- inlined: components/parts-before-after/styles.ts ---- */
...
/* ---- inlined: components/parts-before-after/types.ts ---- */
...
/* ---- inlined: components/parts-before-after/utils.ts ---- */
const BEFORE =
...
function parsePairs(raw: unknown): BeforeAfterPair[] {
...
function defaultSingleImages(): { before: string; after: string } {
...
/* ---- inlined: components/parts-before-after/index.ts ---- */
