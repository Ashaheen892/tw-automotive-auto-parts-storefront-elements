...
function setInnerHTML(el, html2) {
  html2 === void 0 && (html2 = ""), typeof trustedTypes < "u" ? el.innerHTML = trustedTypes.createPolicy("html", {
    createHTML: /* @__PURE__ */ __name((s) => s, "createHTML")
  }).createHTML(html2) : el.innerHTML = html2;
}
...
function slideTo(index, speed, runCallbacks, internal, initial) {
  ...
  if (params.cssMode) {
    const isH = swiper.isHorizontal(), t2 = rtl ? translate2 : -translate2;
    if (speed === 0)
      ...
      })) : wrapperEl[isH ? "scrollLeft" : "scrollTop"] = t2, isVirtual && requestAnimationFrame(() => {
...
function onTouchMove(event) {
  ...
  let targetTouch;
  if (e.type === "touchmove") {
    if (targetTouch = [...e.changedTouches].find((t2) => t2.identifier === data.touchId), !targetTouch || targetTouch.identifier !== data.touchId) return;
  } else
    targetTouch = e;
  if (!data.isTouched) {
...
const prototypes = {
  ...
  getDirectionLabel(property2) {
    return this.isHorizontal() ? property2 : {
      width: "height",
...
__name(t, "t");
function readSectionTheme(config, prefix, defaults2) {
  const c = config || {};
  return {
    bg: "transparent",
    text: "#000000",
...
const _PartsCategories = class _PartsCategories extends LitElement {
  constructor() {
    super(...arguments), this.config = {}, this.layout = "projects", this.boundLangHandler = () => {
  ...
  remountSwiper() {
    ...
    const root = this.renderRoot.querySelector(".pca-swiper");
    !root || !this.items.length || (this.swiper = mountFsSwiper(root, {
      slidesPerView: "auto",
      spaceBetween: 16
    }));
  }
...
__name(_PartsCategories, "PartsCategories"), _PartsCategories.styles = [sharedSectionCss, fsSwiperCss, componentStyles];
